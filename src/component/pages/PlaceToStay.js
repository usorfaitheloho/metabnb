...
const PlaceToStay = () => {
  ...
  return (
    ...
    <div className="py-8 lg:py-[3rem] px-2 lg:px-8 max-w-[1200px] mx-auto">
        <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center text-sm lg:w-[90%] mx-auto mb-[2rem]">
                <div className="flex flex-col lg:flex-row justify-center lg:justify-between text-center gap-y-4 flex-nowrap w-full lg:scrollbar-hide scroll-smooth mb-4 lg:mb-0 py-4">
